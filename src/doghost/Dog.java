...
public class Dog {
	...
	/**
	 * Restricao que pode tornar a racao mais cara. (i.e. obesos, alergicos,
	 * celiacos, veganos, etc).
	 */
	 ...
	 * @param tutor        Nome do tutor/dono do dog.
	 * @param consumoRacao Quanto de racao o dog consome diariamente.
	 * @param restricao    Restricao quanto a alimentacao do dog. (i.e. obesos,
	 *                     alergicos, celiacos, veganos, etc)
	 */
